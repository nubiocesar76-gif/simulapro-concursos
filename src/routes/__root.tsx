...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SimulaPro — Plataforma de Concursos Públicos" },
      {
        name: "description",
        content:
          "SimulaPro: prepare-se para concursos com questões organizadas por curso, cargo, banca e disciplina.",
      },
      { property: "og:title", content: "SimulaPro — Concursos Públicos" },
      {
        property: "og:description",
        content: "Estude concursos com organização profissional de questões e simulados.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "SimulaPro" },
